...
image:
	...
	docker buildx build --builder=container-builder --platform linux/amd64,linux/arm64,darwin/amd64,darwin/arm64,windows/amd64,windows/arm64 . -t ghcr.io/${REGISTRY}/${APP}:${VERSION} --push
